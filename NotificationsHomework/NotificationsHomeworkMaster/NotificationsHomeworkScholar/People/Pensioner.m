...
-(void) applicationDidEnterBackground: (NSNotification *) notification {
    NSLog(@"\n\n%@: Oh..I'm tired a bit, time to sleep, good night!", _name);
}

//app did enter foreground notification
-(void) applicationWillEnterForeground: (NSNotification *) notification {
    NSLog(@"\n\n%@: Long time no see, i had a good sleep time!", _name);
}
...
- (instancetype) init {
    ...
    if (self) {
        ...
        //subscription for background entering
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(applicationDidEnterBackground:)
                                                     name:UIApplicationDidEnterBackgroundNotification
                                                   object:nil];
        
        //subscription for foreground entering
        [[NSNotificationCenter defaultCenter] addObserver:self
